also check sahih bukhary : https://github.com/kamyarkarzanosman/sahihbukhari/edit/main/سەحیح بوخاری.json
```markdown
# سەحیح موسلیم بە کوردی - Sahih Muslim Kurdish JSON Database

ئەم پڕۆژەیە دەقی تەواوی فەرموودەکانی سەحیح موسلیم بە زمانی کوردی (سۆرانی)، کورمانجی (Latin Kurmanci)، عەرەبی و ئینگلیزی لەخۆ دەگرێت. لەلایەن **Kamyar Karzan Osman Aziz**ـەوە ئامادە و پێداچوونەوەی بۆ کراوە بۆ ئەوەی بە ئاسانی لە پڕۆگرامسازیدا بەکاربهێنرێت.
...
* **فۆرمات:** `JSON`
* **زمانەکان:** کوردی (سۆرانی)، کورمانجی (Kurmanci)، عەرەبی و ئینگلیزی (English)
* **ژمارەی گشتی فەرموودەکان:** ٧٤٥٩ فەرموودە
* **ئامادەکار:** Kamyar Karzan Osman Aziz

---

## پێکهاتەی فایلەکە (JSON Structure)

فایلەکە بە شێوازێکی ڕێکخراو دروستکراوە بۆ ئەوەی لە پرۆژەکاندا بە ئاسانی بەکاربهێنرێت:
  ...
  "hadiths": [
    {
      ...
      "kurdish": {
        "narrator": "ئەبووبەکر کوڕی ئەبوو شەیبە گێڕیەوە...",
        "text": "دەقی فەرموودە..."
      },
      "kurmanci": {
        "narrator": "Ebû Bekir kurê Ebû Şeybe ji me re got...",
        "text": "Mijara hedîsê..."
      },
      "english": {
        "narrator": "Abu Bakr ibn Abu Shaybah narrated to us...",
        "text": "Hadith text..."
      }
    }
  ]
...
```
## چۆنیەتی بەکارهێنان (Usage Examples)
لێرەدا نموونەی بەکارهێنان لە HTML، JavaScript و Python خراوەتە ڕوو.
### ١. نموونەی HTML و JavaScript
دەتوانیت ڕاستەوخۆ داتاکان لە ڕێگەی fetch بخوێنیتەوە و لە پەڕەی وێبدا بە گەڕان بەپێی بەشەکان (Chapters) و ژمارەی فەرموودەکان پیشانی بدەیت:
```html
<!DOCTYPE html>
...
<head>
   ...
   <title>سەحیح موسلیم بە کوردی - Sahih Muslim Kurdish</title>
   <style>
       body {
       ...
       function populateChapters() {
           ...
           if (globalData && globalData.chapters) {
               globalData.chapters.forEach(chapter => {
                   ...
                   // دەتوانیت بۆ گەڕان و SEO کوردی یان کورمانجی هەڵبژێریت
